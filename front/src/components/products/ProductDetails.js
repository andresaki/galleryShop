...
const addToCart = () => {
  ...
  return (
    ...
    {loading ? <i class="fa fa-refresh fa-spin fa-3x fa-fw"></i> :(
      ...
      <div className='row d-flex justify-content-around' id='producto_individual'>
          ...
          <div className='col-12 col-lg-5 mt-5'>
              ...
              <div className="stockCounter d-inline">
                <span className="btn btn-secondary plus" onClick={decreaseQty}>-</span>
                <input type="number" className="form-control count d-inline" value={quantity} readOnly/>
                <span className="btn btn-success minus" onClick={increaseQty}>+</span>
              </div>
              <button type="button" id="carrito_btn" className="btn btn-outline-dark d-inline ml-4" disabled={product.inventario === 0} onClick={addToCart}>Agregar al Carrito</button>
              <hr />
              ...
              data-toggle="modal" data-target="#ratingModal">Deja tu Opinion  &nbsp; <i class="fa fa-comment fa-lg" aria-hidden="true"></i></button>
